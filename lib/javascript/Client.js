...
function zahmeeth_contigfilter(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("zahmeeth_contigfilter.filter_contigs",
