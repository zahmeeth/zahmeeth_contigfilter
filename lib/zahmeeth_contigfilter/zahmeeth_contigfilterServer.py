...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'zahmeeth_contigfilter'):
...
impl_zahmeeth_contigfilter = zahmeeth_contigfilter(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['zahmeeth_contigfilter.filter_contigs_async'] = ['zahmeeth_contigfilter', 'filter_contigs']
async_check_methods['zahmeeth_contigfilter.filter_contigs_check'] = ['zahmeeth_contigfilter', 'filter_contigs']
sync_methods['zahmeeth_contigfilter.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'zahmeeth_contigfilter'
        ...
        self.rpc_service.add(impl_zahmeeth_contigfilter.filter_contigs,
                             name='zahmeeth_contigfilter.filter_contigs',
                             types=[dict])
        self.method_authentication['zahmeeth_contigfilter.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "zahmeeth_contigfilter but no authentication header was passed"
                            raise err
